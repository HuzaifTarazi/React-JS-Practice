...
const TasksList = ({ id, title, desc, priority, dueDate, useArr, SetObjArr }) => {
  const deletion = (e) => {
  ...
  return (
    <>
      <div className="border rounded shadow-lg bg-cyan-700 text-start py-2 px-4 my-3 flex flex-col justify-center items-center">
